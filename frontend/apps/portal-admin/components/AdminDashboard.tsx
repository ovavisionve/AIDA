...
import ControlNumbersSection from "./sections/ControlNumbersSection";
...
type ActiveSection = "dashboard" | "clients" | "users" | "roles" | "control_numbers" | "integrations" | "settings" | "audit";
...
export default function AdminDashboard({ user, onLogout }: AdminDashboardProps) {
  ...
  const navItems = [
    ...
    { id: "control_numbers" as const, label: "Nros. Control", icon: "M7 20l4-16m2 16l4-16M6 9h14M4 15h14" },
    { id: "integrations" as const, label: "Integraciones IA", icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
  ...
  const sections: Record<ActiveSection, React.ReactNode> = {
    ...
    users: <UsersSection />,
    roles: <RolesSection />,
    control_numbers: <ControlNumbersSection />,
