      ...
      <div className="flex min-h-screen items-center justify-center bg-[#0a0f1a]">
        <div className="w-full max-w-md rounded-2xl bg-white/5 border border-white/10 backdrop-blur-lg p-8 shadow-2xl">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-aida-accent to-aida-cyan bg-clip-text text-transparent tracking-tight">AIDA</h1>
          ...
          <tbody className="divide-y divide-white/5">
            {loading ? (
              ...
              <tr key={doc.id} className="border-b border-white/5 hover:bg-white/5">
                ...
                <td className="px-4 py-3"><span className="rounded-full bg-aida-accent/10 px-2 py-0.5 text-[10px] font-medium text-aida-accent">{doc.tipo}</span></td>
                <td className="px-4 py-3 text-gray-300">{doc.emisor_razon_social}</td>
                <td className="px-4 py-3 text-xs text-gray-500">{doc.fecha}</td>
                ...
                <td className="px-4 py-3"><span className="rounded-full bg-emerald-500/10 px-2 py-0.5 text-[10px] font-medium text-emerald-400">{doc.status}</span></td>
...
function TemplateSection({ token, apiUrl }: { token: string; apiUrl: string }) {
  ...
  if (loading) return <div className="text-center py-12 text-gray-500">Cargando plantillas...</div>;
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="rounded-xl bg-white/5 p-5 border border-white/10">
          <p className="text-sm text-gray-500 mb-3">Tu logo aparecera en todos los documentos fiscales generados.</p>
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mb-4">Sube banners que apareceran en tus documentos fiscales.</p>
