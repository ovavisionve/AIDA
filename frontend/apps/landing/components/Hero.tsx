  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden grid-bg">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
        ...
        {/* === CTAs === */}
        <AnimateOnScroll animation="slide-up" delay={400} duration={900}>
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-5 max-w-4xl mx-auto perspective-container">
          {stats.map((s, i) => (
            <AnimateOnScroll key={s.label} animation="scale-in" delay={500 + i * 120} duration={700}>
        ...
        {/* === DASHBOARD MOCKUP 3D === */}
        <AnimateOnScroll animation="slide-up" delay={200} duration={1000} threshold={0.1}>
